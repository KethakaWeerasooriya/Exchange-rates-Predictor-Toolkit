...
trained_output <- as.matrix(lagged_data[1:380, "target"]) 
...
model_1_Description = model_Descri(model_1, model_formula1, hidden_layers = 6)
...
model_2_Description <- model_Descri(model_2, model_formula, hidden_layers = hiddenLayer1)
...
model_3_Description <- model_Descri(model_3, model_formula, hidden_layers = hiddenLayer2)
...
model_4_Description <- model_Descri(model_4, model_formula, hidden_layers = hiddenLayer3, 
                                    learningrate = leariningRate1)
...
model_5_Description <- model_Descri(model_5, model_formula, hidden_layers = c(10, 5))
...
model_7_Description <- model_Descri(model_7, model_formula, hidden_layers = c(6, 3, 2))
...
model_8_Description <- model_Descri(model_8, model_formula, hidden_layers = c(12, 6, 3))
...
model_9_Description <- model_Descri(model_9, model_formula, hidden_layers = c(15, 7, 3))
...
model_10_Description <- model_Descri(model_10, model_formula, hidden_layers = c(20, 10, 5))
...
model_11_Description <- model_Descri(model_11, model_formula, hidden_layers = c(25, 12, 6))
...
model_12_Description <- model_Descri(model_12, model_formula, hidden_layers = c(30, 15, 7))
...
colnames(comparison_table) <- c("Hidden_Layers", "Formula", "Epoch", "Learning_Rate", "Algorithm", 
                                "Activation_Function",
                                "RMSE", "MAE", "MAPE", "Additional_Info1", "Additional_Info2")
